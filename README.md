...
Pobierz FFmpeg ze strony ffmpeg.org.
Umieść plik wykonywalny w katalogu ffmpeg/ wewnątrz projektu.
...
📖 Użycie
Uruchom aplikację.
Wklej URL YouTube, gdy zostaniesz o to poproszony.
Poczekaj na pobranie (postęp będzie wyświetlany w konsoli).
Plik MP4 zostanie zapisany w katalogu downloads/.
